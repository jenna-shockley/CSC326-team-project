...
public enum TransactionType {
    ...
    /**
     * A patient's Emergency Health Record has been viewed by an HCP or
     * Emergency Responder.
     */
    VIEW_EHR ( 1501, "Patient Emergency Health Record viewed", true ),
    /**
     * The PR list has been viewed by the patient.
     */
    VIEW_PR_BY_PATIENT ( 1601, "PR viewed a patient", true ),
    /**
     * The PR list has been viewed by an HCP.
     */
    VIEW_PR_BY_HCP ( 1602, "PR viewed by HCP", false ),
    /**
     * A PR has been added to the list by a patient.
     */
    ADD_PR_BY_PATIENT ( 1603, "PR declared by patient", true ),
    /**
     * A PR has been removed from the list by a patient.
     */
    REMOVE_PR_BY_PATIENT ( 1604, "PR removed by patient", true ),
    /**
     * A patient has removed themself as a PR.
     */
    REMOVE_PR_AS_PR ( 1605, "Patient undeclared themself as a PR", true ),
    /**
     * An HCP has declared a PR for a patient.
     */
    ADD_PR_BY_HCP ( 1606, "PR declared by HCP", true ),
    /**
     * An admin has created a Lab Code.
     */
    ADD_LAB_CODE ( 1701, "Admin added lab code", false ),
    /**
     * An admin has edited a Lab Code.
     */
    EDIT_LAB_CODE ( 1702, "Admin edited lab code", false ),
    /**
     * An admin has deleted a Lab Code.
     */
    DELETE_LAB_CODE ( 1703, "Admin deleted lab code", false ),
    /**
     * An admin has viewed a Lab Code.
     */
    VIEW_LAB_CODES ( 1704, "Admin viewed lab codes", false ),
    /**
     * A HCP created a lab procedure
     */
    ADD_LAB_PROC ( 1705, "HCP added lab procedure to office visit", true ),
    /**
     * A HCP deleted a lab procedure
     */
    DELETE_LAB_PROC ( 1706, "HCP removed lab procedure from office visit", true ),
    /**
     * A labtech viewed lab procedures
     */
    VIEW_LAB_PROCS ( 1707, "Lab tech viewed assigned lab procedures", false ),
    /**
     * A labtech edited lab procedure
     */
    EDIT_LAB_PROC ( 1708, "Lab tech edited assigned lab procedure", false );
