...
public class AdminUserController {
        ...
        if ( result.hasErrors() ) {
            ...
            switch ( u.getRole() ) {
                ...
                case ROLE_HCP:
                    ...
                    break;
                case ROLE_RESPONDER:
                    final Personnel res = new Personnel();
                    res.setSelf( u );
                    res.save();
                    break;
                case ROLE_LABTECH:
                    final Personnel tech = new Personnel();
                    tech.setSelf( u );
                    tech.save();
                    break;
                case ROLE_PATIENT:
    ...
    /**
     * Retrieves the form for the Lab Codes action
     *
     * @param model
     *            Data for front end
     * @return The page to display
     */
    @RequestMapping ( value = "admin/labCodes" )
    @PreAuthorize ( "hasRole('ROLE_ADMIN')" )
    public String labCodes ( final Model model ) {
        model.addAttribute( "users", User.getUsers() );
        return "admin/labCodes";
    }
}
