...
public class OfficeVisitForm implements Serializable {
     ...
     */
    private List<LabProcForm>      labProcs;
    ...
    public OfficeVisitForm ( final OfficeVisit ov ) {
        ...
        setLabProcs( ov.getLabProcs().stream().map( ( final LabProc p ) -> new LabProcForm( p ) )
                .collect( Collectors.toList() ) );
     ...
     */
    public void setLabProcs ( final List<LabProcForm> labProcs ) {
     ...
     */
    public List<LabProcForm> getLabProcs () {
        return labProcs;
    }
}
