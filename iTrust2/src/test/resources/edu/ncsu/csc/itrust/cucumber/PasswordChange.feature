...
Scenario Outline: Change Password Labtech
Given testTech exists in the system
When I login as testTech
And I navigate to the change password page
And I fill out the form with current password <password> and new password <newPassword>
Then My password is updated sucessfully
And I can login with new password
Examples:
	|username   |password|newPassword|
	|testTech   |123456  |123457     |	
